...
#define S_FUNCTION_NAME salsnes_bsm2N_nopoly_fastspeed
...
static void mdlOutputs(double *y, double *x, double *u, SimStruct *S, int tid)
{
  ...
  tss_eff=0.41;    /* Calculated separately running Trojan model with PI. 41 % for no poly, 49% for with poly 2 ppm, 57% fo with poly 4 ppm */
